...
export default function FAQPage() {
    return (
        <div className="max-w-3xl mx-auto px-4 py-16 animate-fade-in">
            <h1 className="text-3xl font-black mb-10 text-zinc-900 dark:text-zinc-50 text-center">자주 묻는 질문</h1>
            ...
            <div className="space-y-6">
                {[
                    ...
                    <div key={i} className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-2xl p-6">
                        <h3 className="font-bold text-lg mb-2 text-zinc-900 dark:text-zinc-50 flex items-start gap-2">
