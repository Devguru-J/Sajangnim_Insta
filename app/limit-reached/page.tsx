    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center p-4 animate-fade-in">
            <div className="w-full max-w-[520px] bg-white dark:bg-surface-dark rounded-[2rem] shadow-2xl p-10 border border-gray-100 dark:border-white/5 text-center flex flex-col items-center">
                ...
                <div className="w-full bg-background-light dark:bg-neutral-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 mb-8 text-left">
                    <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-4 mb-4">
                        <div>
                            <h3 className="font-bold text-text-main dark:text-white">베이직 요금제</h3>
                            <div className="text-primary font-black text-2xl">5,900원<span className="text-xs font-normal text-text-sub dark:text-gray-400">/월</span></div>
                        </div>
