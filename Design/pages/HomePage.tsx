          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl font-black tracking-tight text-text-main dark:text-white leading-[1.15] mb-6">
                ...
                <span className="relative inline-block">
                  오늘도 사장님 손 멈췄나요?
                  <span className="absolute bottom-1 left-0 w-full h-3 bg-primary/30 -z-10 rounded-sm transform -rotate-1"></span>
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link to="/create" className="flex items-center justify-center gap-2 bg-primary hover:bg-primary-hover transition-colors text-white font-bold text-lg h-14 px-8 rounded-xl shadow-lg shadow-primary/20">
                  오늘 올릴 글 지금 만들기
            ...
            <div className="flex-1 w-full max-w-[500px] lg:max-w-none">
              <div className="relative group">
                ...
                <div className="relative bg-white dark:bg-neutral-800 rounded-xl overflow-hidden shadow-2xl border border-gray-100 dark:border-white/10 aspect-[4/3] flex items-center justify-center bg-cover bg-center" style={{backgroundImage: "url('https://picsum.photos/seed/cafe/800/600')"}}>
                   <div className="absolute bottom-6 left-6 right-6 bg-white/90 dark:bg-black/80 backdrop-blur-sm p-4 rounded-lg shadow-lg">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="size-10 rounded-full bg-gray-200 bg-cover bg-center" style={{backgroundImage: "url('https://picsum.photos/seed/avatar/100/100')"}}></div>
                        <div>
      ...
      <section className="py-20 bg-white dark:bg-neutral-900">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-text-main dark:text-white mb-4">서비스 핵심 가치</h2>
            <p className="text-text-sub dark:text-gray-400">사장님의 마케팅 고민을 해결해 드리는 세 가지 약속</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "생각 멈춤 없이 즉시 완성", desc: "하루 평균 20분 글 고민 시간 절약. 키워드만 넣으면 최적의 글이 나옵니다.", icon: "timer_off" },
              { title: "사진 분위기에 딱 맞는 감성", desc: "딱딱한 로봇 말투가 아닙니다. 손님이 먼저 말 걸고 싶은 감성을 담습니다.", icon: "auto_fix_high" },
              { title: "해시태그 추천 자동화", desc: "우리 동네 손님들이 검색하는 알짜 해시태그를 알아서 달아드립니다.", icon: "tag" }
            ].map((f, i) => (
