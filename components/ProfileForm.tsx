    ...
    return (
        <>
            ...
            <form action={formAction} className="space-y-8">
                {state.message && (
                    <div className={`p-4 rounded-xl font-bold text-center ${state.success ? 'bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400' : 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400'
                        }`}>
                        {state.message}
                    </div>
                )}
